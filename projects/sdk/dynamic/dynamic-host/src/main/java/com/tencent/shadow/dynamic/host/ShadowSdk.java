...
public class ShadowSdk {
    ...
    public static void enter(Context context, final long fromId, Bundle bundle, EnterCallback enterCallback) throws Exception {
        ...
        upgradeablePluginManager.enter(context, fromId, bundle, enterCallback);
    }
