...
/**
 * 多个插件公共的PackageManager
 * 用于插件之间相互查询PackageManager相关信息
 *
 * @author cubershi
 */
class CommonPluginPackageManager : PackageManager() {
    private val mPluginInfoSet = mutableSetOf<PluginInfo>()

    fun addPluginInfo(pluginInfo: PluginInfo) {
        mPluginInfoSet.add(pluginInfo)
    }

    override fun getActivityInfo(component: ComponentName, flags: Int): ActivityInfo {
        val find = mPluginInfoSet.flatMap { it.mActivities }.find {
